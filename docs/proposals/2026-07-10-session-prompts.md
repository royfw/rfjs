...
**開在**:hq · **啟動條件**:交接檔仍在(scratchpad 會被清,先搬)

```
把「提案視覺輔助」落成一個跨專案 skill。交接檔兩份:
/tmp/claude-1000/-home-royfw---code-royfw-rfjs/50461647-441d-426e-9f30-2df87524236f/scratchpad/hq-handoff/proposal-visual-aid-skill-draft.md
/tmp/claude-1000/-home-royfw---code-royfw-rfjs/50461647-441d-426e-9f30-2df87524236f/scratchpad/hq-handoff/proposal-visual-base.html
先把兩檔複製進 hq 保存(scratchpad 會被清),再照 hq 的 skill 慣例安置,讓所有專案的
session 在提案/比較/路線圖時自動產出一致樣式的本地 HTML 輔助。
```
