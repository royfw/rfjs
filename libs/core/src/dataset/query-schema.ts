...
// `.strict()` rejects unknown/misspelled keys (e.g. a typo'd field, or a leaf carrying
// stray group keys) with a 400 instead of silently dropping them.
const ColumnLeafSchema = z
  .object({
...
export const QueryDatasetsBodySchema = z
  .object({
