        ...
        >
          ...
          >
            <SelectTrigger
              ...
              className={`h-[22px]! min-h-0 w-auto shrink-0 rounded-md border-0 px-2 py-0 font-mono text-[11px] font-semibold leading-none [&>svg]:hidden ${dataTypeBadge(f.dataType)}`}
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
